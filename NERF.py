...
def train(nerf_model, optimizer, scheduler, train_loader, device='cpu', hn=0, hf=1, nb_epochs=int(1e5),
...
if __name__ == '__main__':
    ...
    # With this line
    train_data_path = './nerf_synthetic/lego'  # Replace with your path
    test_data_path = './nerf_synthetic/lego'  # Replace with your path
    train_dataset = NeRFDatasetLoader(train_data_path, mode="train")
    test_dataset = NeRFDatasetLoader(test_data_path, mode="test")

    # training_dataset = NeRFDatasetLoader('/nerf_synthetic/lego', 'train')
    # testing_dataset = NeRFDatasetLoader('/nerf_synthetic/lego', 'test')
    ...
    train(model, model_optimizer, scheduler, train_loader, nb_epochs=16, device=device, hn=2, hf=6, nb_bins=192, H=400,
          W=400)
